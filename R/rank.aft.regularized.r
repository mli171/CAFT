...
estimate.rank.aft = function(y, delta, x, Gamma=NULL, Lambda=NULL, Gamma.ginv=NULL, Lambda.ginv=NULL, b=NULL, beta=NULL,
  ...
  if( n.var==1 ) {
    ...
    res=optim(param0, gr=grad.J.n, fn=fcn.J.n, method='BFGS', y=y, delta=delta,
              x=x, Gamma=Gamma, Lambda=Lambda,
              Gamma.ginv=Gamma.ginv, Lambda.ginv=Lambda.ginv,
              b=b, n.gamma=n.gamma, n.lambda=n.lambda, regularize=regularize,
...
#' @keywords internal
#' @noRd
fcn.J.n = function(par, y, delta, x, Gamma, Lambda, Gamma.ginv, Lambda.ginv, n.gamma, n.lambda, b, regularize) {
...
#' @keywords internal
#' @noRd
grad.J.n = function(par, y, delta, x, Gamma, Lambda, Gamma.ginv, Lambda.ginv, n.gamma, n.lambda, b, regularize) {
