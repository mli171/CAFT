...
We use the Colon data to illustrate multivariate covariates such as multigroup categorial data.  Here we also use the **phyloseq** package to extract the data: note that **phyloseq** is not required to run **CAFT**.
